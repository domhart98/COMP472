...
#load validation set
val_set = pd.read_csv('C:\\Users\\domha\\PycharmProjects\\comp472\\assignment1\\Assig1-Dataset\\Assig1-Dataset\\test_with_label_'+file_suffix,
                      delimiter=',', header=None)
...
#cast output to objects of type DataFrame, so we can output to csv file using panda
